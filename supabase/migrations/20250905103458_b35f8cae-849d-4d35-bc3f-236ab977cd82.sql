...
-- Normaliser et contraindre admin_files
-- D'abord normaliser les catégories existantes
UPDATE admin_files SET file_category = 'cv' WHERE LOWER(file_category) = 'cv';
UPDATE admin_files SET file_category = 'template' WHERE LOWER(file_category) IN ('template', 'checklist');
UPDATE admin_files SET file_category = 'image' WHERE LOWER(file_category) IN ('icons', 'diagram');
