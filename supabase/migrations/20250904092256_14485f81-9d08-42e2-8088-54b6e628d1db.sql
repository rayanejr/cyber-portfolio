...
INSERT INTO security_logs (event_type, severity, source, metadata)
VALUES (
  'SECURITY_HARDENING',
  'INFO', 
  'SYSTEM',
  jsonb_build_object(
    'action', 'RLS_POLICY_HARDENING',
    'description', 'Removed overly permissive RLS policies and tightened access controls',
    'affected_tables', ARRAY['contact_messages', 'admin_files', 'blogs', 'certifications', 'experiences', 'formations', 'projects', 'skills', 'tools']
  )
);